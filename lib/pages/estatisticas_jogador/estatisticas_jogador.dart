    ...
    return ResponsiveBuilder(
      builder: (context, sizingInformation) {
        if (!sizingInformation.isDesktop) {
          return JogadorEstatisticasMobile(idJogador: widget.idJogador);
        } else {
          return Scaffold(
                  ...
                  children: [
                    Expanded(
                      child: Container(
                        ...
                        padding:
                            EdgeInsets.all(fatorDeEscalaMenor(25, context)),
                        child: Column(
                          children: [
                            CircleAvatar(
                              backgroundColor: Colors.grey,
                              backgroundImage:
                                  jogadorRepository.jogador.image == null
                                      ? null
                                      : NetworkImage(
                                          jogadorRepository.jogador.image!),
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton(
                                  ...
                                  items: [
                                    ...
                                    for (String i
                                        in jogadorRepository.formacoes)
                                      DropdownMenuItem(
                                          value: i,
                                          child: Padding(
                                ...
                                if (geral) {
                                  return Row(
                                    ...
                                    children: [
                                      ...
                                      containerNota(jogadorRepository
                                              .estatisticas?.nota ??
                                          0)
                                    ],
                                  );
